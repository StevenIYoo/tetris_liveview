defmodule TetrisTest do
  ...
  test "try to move right, success" do
    brick = Brick.new_brick(location: {5, 1})
    bottom = %{}
  ...
  test "try to move right, failure returns original brick" do
    brick = Brick.new_brick(location: {8, 1})
    bottom = %{}
  ...
  test "drops without merging" do
    brick = Brick.new_brick(location: {5, 5})
    bottom = %{}
  ...
  test "drops and merges" do
    brick = Brick.new_brick(location: {5, 16})
    bottom = %{}
  ...
  test "drops to bottom and compresses" do
    ...
    bottom = for x <- 1..10, y <- 17..20, x != 7 do
      {{x, y}, {x, y, :red}}
    end
    |> Map.new()
